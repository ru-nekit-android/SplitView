package com.projectcocoon.p2p.managers
{
	...
	public class GroupManager extends EventDispatcher
	{
		...
		public function createNetGroup(name:String, postPassword:String = null, postPasswordSalt:String = null, publishPassword:String = null, publishPasswordSalt:String = null):NetGroup
		{
			...
			if( postPassword )
			{
				groupSpec.setPostingPassword(postPassword, postPasswordSalt);
			}
			if( publishPassword )
			{
				groupSpec.setPublishPassword(publishPassword, publishPasswordSalt);
			}
		...
		public function sendMessageToAll(value:Object, netGroup:NetGroup, type:String = "message", command:String = null):MessageVO
		{
		...
		public function sendMessageToClient(value:Object, netGroup:NetGroup, client:ClientVO, type:String = "message", command:String = null):MessageVO
		{
			return sendMessageToGroupAddress(value, netGroup, client.groupID, type, command);
		}
		
		public function sendMessageToGroupAddress(value:Object, netGroup:NetGroup, groupAddress:String,type:String = "message", command:String = null):MessageVO
		{
			var client:ClientVO = getLocalClient(netGroup);
			if (client)
			{
				var msg:MessageVO = new MessageVO(client, value, groupAddress, type, command);
				var result:String = netGroup.sendToNearest(msg, groupAddress);
				return msg;
			}
			return null;
		}

...
public class ViewMenuItemSkin extends spark.skins.mobile.ButtonSkin
{
    ...
    public function ViewMenuItemSkin()
    {
        ...
        switch (applicationDPI)
        {
            ...
            {
                borderSkin = spark.skins.ios320.assets.Button_fillUp;
            ...
            {
                borderSkin = spark.skins.ios240.assets.Button_fillUp;
            ...
            default:
            {
                borderSkin = spark.skins.ios160.assets.Button_fillUp;
